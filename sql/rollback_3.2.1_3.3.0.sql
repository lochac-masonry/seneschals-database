...
#-- System      : SenDb
#--
#-- Filename    : rollback_3.2.1_3.3.0.sql
#--
...
migrate:BEGIN
    ...
    IF (versionTableExists = 0) THEN
        SELECT 'This script can only run on a version 3.3.0 database' AS result
        UNION
    ...
    ALTER TABLE events
    RENAME COLUMN meetsInsuranceConditionHighIncome TO notifyInsurer,
    DROP COLUMN meetsInsuranceConditionAnimalUse;
    ...
    SELECT 'Rollback complete. Now at version 3.2.1.' AS result;
