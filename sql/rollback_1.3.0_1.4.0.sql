...
#-- System      : SenDb
#--
#-- Filename    : rollback_1.3.0_1.4.0.sql
#--
...
migrate:BEGIN
    ...
    END IF;
                                                            ...
                                                            #-----------------------------------------------------------
    #-- Not feasible to rollback the changes to default values or the MyISAM to InnoDB migration.
    ...
    SELECT 'Rollback complete. Now at version 1.3.0.' AS result;
